            ...
            <div class="card">
                <form action="" method="post">
                    ...
                    <div class="card-header">
                        <h3 class="card-title">
                            <i class="fas fa-plus fa-sm"></i> Edit Supplier
                        </h3>
                            ...
                            <div class="col-lg-8 mb-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="telpon" class="form-control" id="telpon"
                                        placeholder="nomor telpon supplier" pattern="[0-9]{5,}" title="minimal 5 angka" 
                                        value="<?= $supplier['telpon'] ?>"
                                        required>
                                </div>
                                <div class="form-group">
