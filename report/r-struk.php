...
<body>
    ...
    <table style="border-bottom: dotted 2px; font-size: 14px; width: 240px;">
        ...
        ?>
            ...
            <tr>
                ...
                <td style="width: 70px; text-align:right;">x <?= number_format
                ($item['harga_jual'],0,',','.') ?></td>
                <td style="width: 70px; text-align:right;" colspan="2"><?= number_format
                ($item['jml_harga'],0,',','.') ?></td>
            </tr>
        <?php } ?>
    </table>
    ...
    <table style="border-bottom: dotted 2px; font-size: 14px; width: 240px;">
        <tr>
            ...
            number_format($dataJual['total'],0,',','.') ?></b></td>
        </tr>
        <tr>
            <td colspan="3" style="width: 100px;"></td>
            <td style="width: 50px; text-align:right">Bayar</td>
            <td style="width: 70px; text-align:right" colspan="2"><b><?= 
            number_format($dataJual['jml_bayar'],0,',','.') ?></b></td>
        </tr>
    </table>
    ...
    <table style="border-bottom: solid 2px; font-size: 14px; width: 240px;">
        <tr>
            ...
            <td style="width: 70px; text-align:right" colspan="2"><b><?= 
            number_format($dataJual['kembalian'],0,',','.') ?></b></td>
        </tr>
    </table>
