...
<div class="card">
    <form action="" method="post">
        <div class="card-header">
            ...
            <button type="reset" name="reset" class="btn btn-danger btn-sm float-right mr-1">
...
?>
        ...
        <div class="form-group">
            ...
            <input type="password" name="newPass" id="newPass"
                class="form-control"
                placeholder="masukkan password beru anda" required>
        </div>
        <div class="form-group">
            <label for="curPass">confirm Password</label>
            <input type="password" name="confPass" id="confPass"
                class="form-control"
                placeholder="masukkan kembali password beru anda" required>
                <?php
if ($msg == 'err1') {
    echo $alert;
}
