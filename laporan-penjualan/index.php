        ...
        <div class="container-fluid">
            <div class="card">
                <div class="card-header">
                    ...
                    data-target="#mdlPeriodeJual"><i class="fas fa-print"></i> Cetak</button>
                </div>
                        ...
                        <tbody>
                            ...
                            foreach($penjualan as $jual){ ?>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center"><a href="detail-penjualan.php?id=<?= $jual['no_jual'] ?>&tgl=<?= in_date($jual['tgl_jual']) ?>"
