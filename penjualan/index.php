...
// jika tombol tambha barang ditekan
...
<div class="content-wrapper">
                        ...
                        <div class="card card-outline card-warning p-3">
                            ...
                            <div class="form-group row mb-2">
                                ...
                                <div class="col-sm-10 input-group">
                                    ...
                                    id="barcode" value="<?= @$_GET['barcode'] ? $_GET['barcode'] : '' ?>" class="form-control" placeholder="masukkan barcode barang">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                ...
                                id="jmlHarga" value="<?= @$_GET['barcode'] ?
                                $selectBrg['harga_jual'] : '' ?>" readonly>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card card-outline card-success table-responsive px-2">
                    <table class="table table-sm table-hover text-nowrap">
                        ...
                        <tbody>
                            <?php
                            $no = 1;
                            $brgDetail = getData("SELECT * FROM tbl_jual_detail WHERE 
                            no_jual = '$nojual'");
    ...
    <script>
        ...
        barcode.addEventListener('change', function(){
            document.location.href = '?barcode=' + barcode.value + '&tgl=' + tgl.
            value;
        })
